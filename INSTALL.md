# Install Pressure Pottymouth

This repository is an always-loaded instruction profile, not an on-demand skill. Install the contents of `INSTRUCTIONS.md` as persistent global instructions for every supported coding agent available on the machine.
